      ...
      stage ('OWASP Dependency-Check Vulnerabilities') {
        ...
        stage('Deploying to Dev Enviroment') {
            steps {
                ...
                docker tag frontend:latest 847280823661.dkr.ecr.us-east-1.amazonaws.com/frontend:latest
                docker tag frontend:latest 847280823661.dkr.ecr.us-east-1.amazonaws.com/frontend-rollback:$Commit
                echo Remove old Image from ECR
                aws ecr batch-delete-image --repository-name frontend --image-ids imageTag=latest --region us-east-1
                echo Pushing image ECR
                docker push 847280823661.dkr.ecr.us-east-1.amazonaws.com/frontend:latest
                docker push 847280823661.dkr.ecr.us-east-1.amazonaws.com/frontend-rollback:$Commit
                              
                aws ecs update-service --cluster scrum-backend-cluster --service ui --region us-east-1 --force-new-deployment 
                sleep 15
                aws ecs list-tasks --cluster scrum-backend-cluster --service ui --region us-east-1              
                
                echo "==========Removing Docker images from Jenkins========="
                
                docker rmi -f 847280823661.dkr.ecr.us-east-1.amazonaws.com/frontend:latest
                docker rmi -f 847280823661.dkr.ecr.us-east-1.amazonaws.com/frontend-rollback:$Commit
                docker rmi -f frontend-rollback:$Commit
